...
def main():
	(num_sessions, min_students, max_students, sess_dict) = readSessionFile("sample_data/sessions.csv")

	#sess_list = list(sess_dict.values())

	student_data = readStudentFile("sample_data/students.csv")
	selection_data = readSelectionFile("output/schedule.csv", student_data, sess_dict)
